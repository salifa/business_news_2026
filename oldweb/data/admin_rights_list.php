...
$pageMask[$table] = $mask;
$tables[$table] = array("placard", " " . GetTableCaption("placard"));
$table = "choices";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("choices", " " . GetTableCaption("choices"));
$table = "popup_1";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("popup_1", " " . GetTableCaption("popup_1"));
...
$pageMask[$table] = $mask;
$tables[$table] = array("credit_transactions", " " . GetTableCaption("credit_transactions"));
...
$pageMask[$table] = $mask;
$tables[$table] = array("credit_transactions_admin", " " . GetTableCaption("credit_transactions_admin"));
$table = "payment";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("payment_admin", " " . GetTableCaption("payment_admin"));
$table = "payment slip";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("payment_slip", " " . GetTableCaption("payment_slip"));
$table = "popup_key_value";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("popup_key_value", " " . GetTableCaption("popup_key_value"));
$table = "placard admin";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("placard_admin", " " . GetTableCaption("placard_admin"));
$table = "credit_admin";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("credit_admin", " " . GetTableCaption("credit_admin"));
...
$pageMask[$table] = $mask;
$tables[$table] = array("placard_download", " " . GetTableCaption("placard_download"));
$table = "online_placard_users";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("online_placard_users", " " . GetTableCaption("online_placard_users"));
