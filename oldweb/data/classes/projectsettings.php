...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "vnnsbiz_at_192_168_1_111";
		}
		return $connId;
	}
...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("online_placard_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "placard" ] = array( "url" => "placard", "type" => 0 );
	$projectEntitiesReverse[ "placard" ] = "placard";
	$projectEntities[ "choices" ] = array( "url" => "choices", "type" => 0 );
	$projectEntitiesReverse[ "choices" ] = "choices";
	$projectEntities[ "popup_1" ] = array( "url" => "popup_1", "type" => 1 );
	$projectEntitiesReverse[ "popup_1" ] = "popup_1";
	$projectEntities[ "credit_transactions" ] = array( "url" => "credit_transactions", "type" => 0 );
	$projectEntitiesReverse[ "credit_transactions" ] = "credit_transactions";
	$projectEntities[ "credit_transactions_admin" ] = array( "url" => "credit_transactions_admin", "type" => 1 );
	$projectEntitiesReverse[ "credit_transactions_admin" ] = "credit_transactions_admin";
	$projectEntities[ "payment" ] = array( "url" => "payment", "type" => 0 );
	$projectEntitiesReverse[ "payment" ] = "payment";
	$projectEntities[ "payment admin" ] = array( "url" => "payment_admin", "type" => 1 );
	$projectEntitiesReverse[ "payment_admin" ] = "payment admin";
	$projectEntities[ "payment slip" ] = array( "url" => "payment_slip", "type" => 1 );
	$projectEntitiesReverse[ "payment_slip" ] = "payment slip";
	$projectEntities[ "popup_key_value" ] = array( "url" => "popup_key_value", "type" => 0 );
	$projectEntitiesReverse[ "popup_key_value" ] = "popup_key_value";
	$projectEntities[ "placard admin" ] = array( "url" => "placard_admin", "type" => 1 );
	$projectEntitiesReverse[ "placard_admin" ] = "placard admin";
	$projectEntities[ "credit_admin" ] = array( "url" => "credit_admin", "type" => 1 );
	$projectEntitiesReverse[ "credit_admin" ] = "credit_admin";
	$projectEntities[ "placard_download" ] = array( "url" => "placard_download", "type" => 1 );
	$projectEntitiesReverse[ "placard_download" ] = "placard_download";
	$projectEntities[ "admin_rights" ] = array( "url" => "admin_rights", "type" => 1 );
	$projectEntitiesReverse[ "admin_rights" ] = "admin_rights";
	$projectEntities[ "online_placard_users" ] = array( "url" => "online_placard_users", "type" => 0 );
	$projectEntitiesReverse[ "online_placard_users" ] = "online_placard_users";
