...
$tdataadmin_members[".OriginalTable"] = "online_placard_users";
...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsadmin_members["English"]["ext_security_id"] = "Ext Security Id";
	$fieldToolTipsadmin_members["English"]["ext_security_id"] = "";
	$placeHoldersadmin_members["English"]["ext_security_id"] = "";
...
if(mlang_getcurrentlang()=="Thai")
{
	...
	$fieldLabelsadmin_members["Thai"]["username"] = "Username";
	$fieldToolTipsadmin_members["Thai"]["username"] = "";
	$placeHoldersadmin_members["Thai"]["username"] = "";
	$fieldLabelsadmin_members["Thai"]["password"] = "Password";
	$fieldToolTipsadmin_members["Thai"]["password"] = "";
	$placeHoldersadmin_members["Thai"]["password"] = "";
	$fieldLabelsadmin_members["Thai"]["email"] = "Email";
	$fieldToolTipsadmin_members["Thai"]["email"] = "";
	$placeHoldersadmin_members["Thai"]["email"] = "";
	$fieldLabelsadmin_members["Thai"]["fullname"] = "Fullname";
	$fieldToolTipsadmin_members["Thai"]["fullname"] = "";
	$placeHoldersadmin_members["Thai"]["fullname"] = "";
	$fieldLabelsadmin_members["Thai"]["groupid"] = "Groupid";
	$fieldToolTipsadmin_members["Thai"]["groupid"] = "";
	$placeHoldersadmin_members["Thai"]["groupid"] = "";
	$fieldLabelsadmin_members["Thai"]["active"] = "Active";
	$fieldToolTipsadmin_members["Thai"]["active"] = "";
	$placeHoldersadmin_members["Thai"]["active"] = "";
	$fieldLabelsadmin_members["Thai"]["ext_security_id"] = "Ext Security Id";
	$fieldToolTipsadmin_members["Thai"]["ext_security_id"] = "";
	$placeHoldersadmin_members["Thai"]["ext_security_id"] = "";
	$fieldLabelsadmin_members["Thai"]["reset_token"] = "Reset Token";
	$fieldToolTipsadmin_members["Thai"]["reset_token"] = "";
	$placeHoldersadmin_members["Thai"]["reset_token"] = "";
	$fieldLabelsadmin_members["Thai"]["reset_date"] = "Reset Date";
	$fieldToolTipsadmin_members["Thai"]["reset_date"] = "";
	$placeHoldersadmin_members["Thai"]["reset_date"] = "";
...
$tdataadmin_members[".connId"] = "vnnsbiz_at_192_168_1_111";


$tdataadmin_members[".strOriginalTableName"] = "online_placard_users";
...
$tdataadmin_members[".sqlHead"] = "SELECT ID,  	username,  	password,  	email,  	fullname,  	groupid,  	active,  	ext_security_id,  	reset_token,  	reset_date,  	apikey";
$tdataadmin_members[".sqlFrom"] = "FROM online_placard_users";
...
$proto29["m_srcTableName"] = "admin_members";
