...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("placard" == $this->chrt_array['tables'][0])
			return true;
		if("choices" == $this->chrt_array['tables'][0])
			return true;
		if("choices" == $this->chrt_array['tables'][0])
			return true;
		if("credit_transactions" == $this->chrt_array['tables'][0])
			return true;
		if("credit_transactions" == $this->chrt_array['tables'][0])
			return true;
		if("payment" == $this->chrt_array['tables'][0])
			return true;
		if("payment" == $this->chrt_array['tables'][0])
			return true;
		if("payment" == $this->chrt_array['tables'][0])
			return true;
		if("popup_key_value" == $this->chrt_array['tables'][0])
			return true;
		if("placard" == $this->chrt_array['tables'][0])
			return true;
		if("credit_transactions" == $this->chrt_array['tables'][0])
		...
		if("placard" == $this->chrt_array['tables'][0])
			return true;
		if("online_placard_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("online_placard_users" == $this->chrt_array['tables'][0])
			return true;
		if("online_placard_users" == $this->chrt_array['tables'][0])
			return true;
		if("online_placard_users" == $this->chrt_array['tables'][0])
