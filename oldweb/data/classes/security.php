...
class Security
{
	...
	public static function getUserGroups()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "online_placard_uggroups" ) . " WHERE " . $grConnection->addFieldWrappers( "GroupID" )
	...
	public static function getUgMembersDatasource() {
		...
		global $cman;
		return getTableDataSource( "online_placard_ugmembers", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgGroupsDatasource() {
		...
		global $cman;
		return getTableDataSource( "online_placard_uggroups", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgRightsDatasource() {
		...
		global $cman;
		return getTableDataSource( "online_placard_ugrights", $cman->getUserGroupsConnId() );
	}
