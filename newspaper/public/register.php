...
<head>
    ...
    <title>ลงทะเบียน - <?php echo NEWSPAPER_NAME; ?></title>
    ...
    <div class="register-body">
        ...
        <form method="POST" action="" id="registerForm">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="fullname" name="fullname" required
                           placeholder="ชื่อเต็มของคุณ" value="<?php echo isset($_POST['fullname']) ? escape($_POST['fullname']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-text">ใช้สำหรับเข้าสู่ระบบและรับข้อมูลข่าวสาร</div>
            </div>
            ...
            <div class="mb-3 form-check">
                ...
                <label class="form-check-label" for="agree">
                    ฉันยอมรับ <a href="#" target="_blank">ข้อกำหนดและเงื่อนไข</a>
                </label>
            </div>
        ...
        <div class="text-center">
            <p class="mb-0">มีบัญชีอยู่แล้ว? <a href="login.php" class="fw-bold text-decoration-none">เข้าสู่ระบบ</a></p>
        </div>
...
document.getElementById('password').addEventListener('input', function() {
    ...
    strengthBar.classList.remove('bg-danger', 'bg-warning', 'bg-success', 'bg-secondary');
