...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "vnnsbiz_at_192_168_1_111";
	$data["connName"] = "vnnsbiz at vnn.mac.in.th";
	$data["connStringType"] = "mysql";
	$data["connectionString"] = "mysql;localhost;salifa;Araigodai@123;;vnnsbiz;https://vnn.mac.in.th/phprun/phprunner.php;0"; //currently unused

	$this->_connectionsIdByName["vnnsbiz at vnn.mac.in.th"] = "vnnsbiz_at_192_168_1_111";
		$data["ODBCUID"] = "salifa";
		$data["ODBCPWD"] = "Araigodai@123";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][1] = "salifa";
		$data["connInfo"][2] = "Araigodai@123";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "vnnsbiz";
	$data["connInfo"][5] = "https://vnn.mac.in.th/phprun/phprunner.php"; //currently unused
		$data["connInfo"][6] = "0"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 5.3 Unicode Driver};Server=localhost;Uid=salifa;Pwd=Araigodai@123;Database=vnnsbiz;OPTION=3";
		// encription set
		...
		$connectionsData["vnnsbiz_at_192_168_1_111"] = $data;
