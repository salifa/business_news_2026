...
$nonAdminTablesArr[] = "placard";
$nonAdminTablesArr[] = "choices";
$nonAdminTablesArr[] = "popup_1";
$nonAdminTablesArr[] = "credit_transactions";
$nonAdminTablesArr[] = "credit_transactions_admin";
$nonAdminTablesArr[] = "payment";
$nonAdminTablesArr[] = "payment admin";
$nonAdminTablesArr[] = "payment slip";
$nonAdminTablesArr[] = "popup_key_value";
$nonAdminTablesArr[] = "placard admin";
$nonAdminTablesArr[] = "credit_admin";
$nonAdminTablesArr[] = "placard_download";
$nonAdminTablesArr[] = "online_placard_users";
...
$wGroupTableName = $ug_connection->addTableWrappers( "online_placard_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "online_placard_ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "online_placard_ugrights" );
