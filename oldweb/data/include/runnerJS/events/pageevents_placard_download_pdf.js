...
Runner.pages.PageSettings.addPageEvent('placard_download_pdf', Runner.pages.constants.PAGE_ADD, "afterPageReady", function(pageObj, proxy, pageid, inlineRow, inlineObject, row ) {
...
//	content_1 = content_1 + '2. \n' ;
	...
	if (contentCtrlstr.length == 0 ) 
		...
		submit = function() {
			params["table"] = "placard_download_pdf";
